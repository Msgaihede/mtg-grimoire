...
/// stays off this list for ever. And `deck_tokens` is v37's, which the spec predates by
...
pub(crate) mod tests {
    ...
    /// upsert); the two above are held here, and [`DECK_TOKEN_GRAIN`] — v37's, and the sixth —
