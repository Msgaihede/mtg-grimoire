...
///
/// The `DELETE FROM decks` is the whole of the rest — `deck_cards`, `deck_categories`,
/// `deck_tags`, `deck_audit`, `deck_undo` and `deck_allocations` all carry
/// `deck_id … ON DELETE CASCADE`.
///
