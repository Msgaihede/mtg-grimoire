...
- **A new migration step goes at the _bottom_ of the ladder, and takes the
  ...
  `CORPUS_SCHEMA_VERSION` **5** since 2026-09-22 (`cards.keywords`, for the search box's `kw:`,
  on the same shape gate as the three below it — **4** was `sets.printed_size` on 2026-09-15, for
  the home page's set completion), deliberately
  ...
  `cards.produced_mana`** (2026-09-10), **4 is `sets.printed_size` and 5 is `cards.keywords`** —
  **and *every one of them* is gated on the table's shape rather than
