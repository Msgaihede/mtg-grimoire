...
export function reportOf(
  ...
  // The labels the import **made**, said because a label is app-wide: three new rows in the
  // Labels dialog is a consequence of this press that reaches every other deck, and the dialog is
  // closing. A label the reader already had is used and costs no sentence.
  const imported =
    outcome.labelsCreated > 0
