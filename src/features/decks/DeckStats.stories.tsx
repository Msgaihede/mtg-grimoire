...
export const EmptyDeck: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    // No half of the shortfall line: no button offering to wish for nothing, and no "All 0
    ...
    // Neither of the other two, and both are handed a live callback at the meta level — so these
    // absences are the shortfall gate rather than the props. A deck short of nothing has no hole
    // for a pull to fill and nothing to record against, and both plans behind them would answer
