...
const meta = {
  ...
  args: {
    ...
    // (issue #401) — so the shortage figure in a tile's chin and the *you own N of M* clause in
    // its name are drawn as they always were. Set at the meta rather than per story because it
