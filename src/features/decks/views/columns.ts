 ...
 * it is a rule that reads two ways. Nothing in the flow is a corner the app does not reach — every
 * seeded zone but the two railed ones flows — and one empty column is what it draws if it ever
 * does.
 */
