...
export const Shopping: Story = {
  play: async ({ canvas }) => {
    ...
    // Five copies over four lines, and the footer offers the four. A line is a **printing**;
    // the wishes it writes are oracle-grained and fold, which here is one wish each because no
    // two of these four are printings of the same card.
