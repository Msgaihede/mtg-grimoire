 ...
 * the card by the time any of the five overlays can be opened, so an overlay mounting an
 ...
 * marketplace switch would have nothing to refetch. Nothing in the five overlays draws money,
 ...
 *
 * @param cardId The printing being read. **Nullable because five of the six callers are mounted
