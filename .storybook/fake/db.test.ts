...
describe("the busy fault", () => {
  ...
  it("refuses every write there is, and no read", () => {
    ...
    //
    // The tags branch then added three writes and moved it 45 → 47, which is the first time the
    // number has moved by less than the branch added: `tag_mute` and `tag_unmute` take
